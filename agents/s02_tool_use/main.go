...
func init() {
	...
	workdir = dir
	system = fmt.Sprintf("You are a coding agent at %s. Use bash to solve task. Act, do not explain", workdir)
	tools = []anthropic.ToolUnionParam{
		...
		anthropic.ToolUnionParam{OfTool: &anthropic.ToolParam{
			Name:        "read_file",
			Description: param.Opt[string](anthropic.String("Read file content.")),
			InputSchema: anthropic.ToolInputSchemaParam{
				Properties: map[string]map[string]string{
					"path": {"type": "string"},
					"limit": {"type": "integer"},
	   ...
	   anthropic.ToolUnionParam{OfTool: &anthropic.ToolParam{
		Name:        "write_file",
		Description: param.Opt[string](anthropic.String("Write content to file.")),
		InputSchema: anthropic.ToolInputSchemaParam{
			Properties: map[string]map[string]string{
				"path": {"type": "string"},
				"content": {"type": "string"},
		...
		anthropic.ToolUnionParam{OfTool: &anthropic.ToolParam{
			Name:        "edit_file",
			Description: param.Opt[string](anthropic.String("Replace exact text in file.")),
			InputSchema: anthropic.ToolInputSchemaParam{
				Properties: map[string]map[string]string{
					"path": {"type": "string"},
